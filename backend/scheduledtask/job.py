...
if __name__ == '__main__':
    ...
    # 注意：应该在 backend 目录下运行此脚本
    # 命令：python -m scheduledtask.job
    # 或者：python scheduledtask/job.py
    uvicorn.run('scheduledtask.job:job', host="0.0.0.0", port=job_server_port, workers=1)
