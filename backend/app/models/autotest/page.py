...
class ApiMsg(BaseApi):
    ...
    method = fields.CharEnumField(ApiMethodEnum, default=ApiMethodEnum.GET.value, description="请求方式")
    level = fields.CharEnumField(ApiLevelEnum, default=ApiLevelEnum.P1.value, description="接口重要程度：P0、P1、P2")
    ...
    body_type = fields.CharEnumField(ApiBodyTypeEnum, default=ApiBodyTypeEnum.JSON.value,
    ...
    status = fields.CharEnumField(
        DataStatusEnum, default=DataStatusEnum.ENABLE.value, description="此接口状态，对应swagger的废弃状态, enable/disable")
