...
class aitestrebortTestCaseModule(BaseModel):
    ...
    class Meta:
        table = "test_case_module"
        table_description = "测试用例模块表"
...
class aitestrebortTestCaseScreenshot(BaseModel):
    ...
    class Meta:
        table = "test_case_screenshot"
        table_description = "测试用例截图表"
...
class aitestrebortTestSuiteScript(BaseModel):
    ...
    class Meta:
        table = "test_suite_script"
        table_description = "测试套件脚本关联表"
