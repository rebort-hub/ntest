...
class OrchestratorTask(Model):
    ...
    # 状态
    status = fields.CharField(max_length=30, default=OrchestratorTaskStatus.PENDING.value, description="状态")
...
class AgentTask(Model):
    ...
    status = fields.CharField(max_length=20, default=AgentTaskStatus.PENDING.value, description="状态")
