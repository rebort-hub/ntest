...
from app.configs.config import ui_action_mapping_reverse, app_action_mapping_reverse
        ...
        for case_id in self.case_id_list:
            ...
            for index in range(current_case.run_times or 1):
                ...
                for step in self.all_case_steps:
                    ...
                    if self.run_type == 'ui':
                        step.execute_name = ui_action_mapping_reverse.get(step.execute_type, step.execute_type)
                    else:
                        step.execute_name = app_action_mapping_reverse.get(step.execute_type, step.execute_type)
