      ...
      <el-row>
        ...
        <el-col :xs="21" :sm="22" :md="21" :lg="20" :xl="20">
          <div style="margin-left: 5px">
            <el-tabs v-model="taskTab" class="autotest-tabs-header-compact">
              <el-tab-pane name="task">
                <template #label>
                  <span class="autotest-tab-label">
                    <span class="autotest-tab-title">任务列表</span>
                    <el-tooltip content="在当前项目下新增定时/巡检任务" placement="top" :show-after="400">
                      <el-button
                          v-show="queryItems.project_id"
                          type="primary"
                          size="small"
                          class="autotest-tab-primary-btn"
                          @click.stop="showEditDrawer(undefined)"
                      >
