<template>
  <div>
    <el-dialog 
      ...
      <el-tabs v-model="activeName" class="autotest-tabs-header-compact edit-case-dialog-tabs" style="margin-left: 20px;margin-right: 20px">
        ...
        <el-tab-pane name="stepInfo">
          <template #label>
            <span class="autotest-tab-label">
              <span class="autotest-tab-title">步骤管理</span>
              <el-tooltip content="为此用例新增一条测试步骤" placement="top" :show-after="400">
                <el-button
                    v-show="activeName === 'stepInfo'"
                    type="primary"
                    size="small"
                    class="autotest-tab-primary-btn"
                    @click.stop="showAddStepDrawer()"
                >
