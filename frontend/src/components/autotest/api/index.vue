<template>
    <div class="api-list-wrap">
      <el-tabs v-model="activeTab" class="table_padding table_api api-list-tabs autotest-tabs-header-compact">
        <el-tab-pane name="api">
          <template #label>
            <span class="autotest-tab-label">
              <span class="autotest-tab-title">接口列表</span>
              <el-tooltip content="在当前模块下新增接口" placement="top" :show-after="400">
                <el-button
                    v-show="queryItems.module_id"
                    type="primary"
                    size="small"
                    class="autotest-tab-primary-btn"
                    @click.stop="showAddDrawer"
                >
