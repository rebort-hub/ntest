<template>
    <div class="page-list-wrap">
      <el-tabs v-model="activeTab" class="table_padding table_api page-list-tabs autotest-tabs-header-compact">
        <el-tab-pane name="page">
          <template #label>
            <span class="autotest-tab-label">
              <span class="autotest-tab-title">页面列表</span>
              <el-tooltip content="在当前模块下新增页面" placement="top" :show-after="400">
                <el-button
