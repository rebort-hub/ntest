  ...
  <div class="theme-settings">
    ...
    >
      ...
      <el-scrollbar class="theme-settings-scrollbar">
        ...
        <div class="setting-item">
          <div class="setting-label">顶栏背景</div>
          <div class="setting-value">
            <el-color-picker 
        ...
        <div class="setting-item">
          <div class="setting-label">顶栏文字</div>
          <div class="setting-value">
            <el-color-picker 
        ...
        <div class="setting-item">
          <div class="setting-label">菜单背景</div>
          <div class="setting-value">
            <el-color-picker 
        ...
        <div class="setting-item">
          <div class="setting-label">菜单文字</div>
          <div class="setting-value">
            <el-color-picker 
        ...
        <div class="setting-item">
          <div class="setting-label">菜单激活色</div>
          <div class="setting-value">
            <el-color-picker 
        ...
        <div class="layout-switch-container">
          <div
            ...
            :key="item.key"
            class="layout-item"
            @click="applyLayoutMode(item.key)"
          >
            <div class="layout-preview" :class="[item.previewClass, { 'layout-active': isLayoutModeActive(item.key) }]">
              <div class="layout-aside" :style="{ backgroundColor: item.previewAside }"></div>
              <div class="layout-container">
                <div class="layout-header" :style="{ backgroundColor: item.previewHeader }"></div>
                <div class="layout-main"></div>
              </div>
            </div>
            <div :class="isLayoutModeActive(item.key) ? 'layout-tips-active' : 'layout-tips'">
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ item.name }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="setting-item">
          <div class="setting-label">菜单手风琴</div>
          <div class="setting-value">
            <el-switch
              v-model="themeConfig.expandOneMenu"
              size="small"
              @change="onExpandOneMenuChange"
            />
          </div>
        </div>
        <div class="setting-item">
        ...
        <div class="setting-item" v-if="themeConfig.isShowLogo">
          <div class="setting-label">Logo 文案</div>
          <div class="setting-value">
            <el-input 
        ...
        <div class="setting-item">
          <div class="setting-label">显示面包屑</div>
          <div class="setting-value">
            <el-switch
        ...
        <!-- 视觉效果 -->
        <el-divider content-position="left">视觉效果</el-divider>
        <div class="setting-item">
          <div class="setting-label">侧边栏反转</div>
          <div class="setting-value">
            <el-switch
              v-model="themeConfig.asideInverted"
              size="small"
              @change="onAsideInvertedChange"
            />
          </div>
        </div>
        <div class="setting-item">
          <div class="setting-label">头部反转</div>
          <div class="setting-value">
            <el-switch
              v-model="themeConfig.headerInverted"
              size="small"
              @change="onHeaderInvertedChange"
            />
          </div>
        </div>
        <div class="setting-item">
          <div class="setting-label">灰度模式</div>
          <div class="setting-value">
            <el-switch 
        ...
        <div class="setting-item">
          <div class="setting-label">色弱辅助</div>
          <div class="setting-value">
            <el-switch 
        ...
        <div class="setting-item">
          <div class="setting-label">页面水印</div>
          <div class="setting-value">
            <el-switch 
        ...
        <div class="setting-item" v-if="themeConfig.isWartermark">
          <div class="setting-label">水印内容</div>
          <div class="setting-value">
            <el-input 
        ...
        <div class="config-actions">
          <el-alert title="主题配置将实时生效" type="info" :closable="false" />
          <el-button 
            size="default" 
            class="config-btn" 
            type="primary" 
...
const themePresets = [
  { name: "极客绿", primary: "#20a162", topBar: "#ffffff", topBarColor: "#606266", menuBar: "#111827", menuBarColor: "#c7d2fe" },
  { name: "默认蓝", primary: "#409eff", topBar: "#ffffff", topBarColor: "#606266", menuBar: "#111827", menuBarColor: "#c7d2fe" },
  { name: "科技蓝", primary: "#1E71EE", topBar: "#ffffff", topBarColor: "#606266", menuBar: "#111827", menuBarColor: "#dbeafe" },
  { name: "活力橙", primary: "#fa7e23", topBar: "#ffffff", topBarColor: "#606266", menuBar: "#111827", menuBarColor: "#fde68a" },
  { name: "玫红", primary: "#ee4866", topBar: "#ffffff", topBarColor: "#606266", menuBar: "#111827", menuBarColor: "#fecdd3" }
];

const layoutModes = [
  { key: "default", name: "默认", previewClass: "layout-classic", previewAside: "#111827", previewHeader: "#ffffff" },
  { key: "aside-inverted", name: "侧反转", previewClass: "layout-classic", previewAside: "#ffffff", previewHeader: "#ffffff" },
  { key: "header-inverted", name: "头反转", previewClass: "layout-classic", previewAside: "#111827", previewHeader: "#111827" },
  { key: "double-inverted", name: "双反转", previewClass: "layout-classic", previewAside: "#ffffff", previewHeader: "#111827" }
];
...
const applyThemePreset = (preset: any) => {
  ...
  themeConfig.topBar = preset.topBar;
  themeConfig.topBarColor = preset.topBarColor;
  themeConfig.menuBar = preset.menuBar;
  themeConfig.menuBarColor = preset.menuBarColor;
  themeConfig.menuBarActiveColor = preset.primary;
  applyCSSVariables();
  saveConfig();
};
...
const applyLayoutMode = (mode: string) => {
  if (mode === "default") {
    themeConfig.asideInverted = false;
    themeConfig.headerInverted = false;
    themeConfig.menuBar = "#111827";
    themeConfig.menuBarColor = "#c7d2fe";
    themeConfig.topBar = "#ffffff";
    themeConfig.topBarColor = "#606266";
  } else if (mode === "aside-inverted") {
    themeConfig.asideInverted = true;
    themeConfig.headerInverted = false;
    themeConfig.menuBar = "#ffffff";
    themeConfig.menuBarColor = "#303133";
    themeConfig.topBar = "#ffffff";
    themeConfig.topBarColor = "#606266";
  } else if (mode === "header-inverted") {
    themeConfig.asideInverted = false;
    themeConfig.headerInverted = true;
    themeConfig.menuBar = "#111827";
    themeConfig.menuBarColor = "#c7d2fe";
    themeConfig.topBar = "#111827";
    themeConfig.topBarColor = "#e5e7eb";
  } else {
    themeConfig.asideInverted = true;
    themeConfig.headerInverted = true;
    themeConfig.menuBar = "#ffffff";
...
const isLayoutModeActive = (mode: string) => {
  if (mode === "default") return !themeConfig.asideInverted && !themeConfig.headerInverted;
  if (mode === "aside-inverted") return themeConfig.asideInverted && !themeConfig.headerInverted;
  if (mode === "header-inverted") return !themeConfig.asideInverted && themeConfig.headerInverted;
  return themeConfig.asideInverted && themeConfig.headerInverted;
};
...
const onExpandOneMenuChange = () => {
  store.commit('app/stateChange', {
    name: 'expandOneMenu',
    value: themeConfig.expandOneMenu
  });
  saveConfig();
};
...
const onDarkModeChange = () => {
  ...
  window.dispatchEvent(new CustomEvent('theme-mode-changed', {
    detail: { isDark: themeConfig.isDark }
  }));
};
...
const onAsideInvertedChange = () => {
  if (themeConfig.asideInverted) {
    themeConfig.menuBar = '#ffffff';
    themeConfig.menuBarColor = '#303133';
    themeConfig.menuBarActiveColor = themeConfig.primary;
  } else {
    themeConfig.menuBar = '#111827';
    themeConfig.menuBarColor = '#c7d2fe';
    themeConfig.menuBarActiveColor = themeConfig.primary;
...
const onHeaderInvertedChange = () => {
  if (themeConfig.headerInverted) {
    themeConfig.topBar = '#111827';
    themeConfig.topBarColor = '#e5e7eb';
  } else {
    themeConfig.topBar = '#ffffff';
...
const handleToggleThemeMode = (event: Event) => {
  const customEvent = event as CustomEvent<{ isDark?: boolean }>;
  const targetDark = typeof customEvent.detail?.isDark === 'boolean'
    ? customEvent.detail.isDark
    : !themeConfig.isDark;
  themeConfig.isDark = targetDark;
  onDarkModeChange();
};
...
onMounted(() => {
  ...
  window.addEventListener('toggle-theme-mode', handleToggleThemeMode as EventListener);
});

onBeforeUnmount(() => {
  window.removeEventListener('toggle-theme-mode', handleToggleThemeMode as EventListener);
});
