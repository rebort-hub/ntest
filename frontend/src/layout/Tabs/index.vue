...
<style lang="scss" scoped>
  .tabs {
    ...
    align-items: center;
    height: 38px;
    background: var(--el-header-bg-color, var(--system-header-background));
    border-bottom: 1px solid color-mix(in srgb, var(--system-header-border-color) 88%, transparent);
    border-top: none;
    box-shadow: 0 1px 3px rgba(29, 35, 41, 0.06);
    .handle {
      min-width: 95px;
      height: 100%;
      display: flex;
