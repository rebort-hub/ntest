    ...
    <el-dialog 
      ...
      <el-form
        ...
        <el-form-item label="配置code" prop="name" class="is-required" size="small">
          <el-input v-model="formData.name" :disabled="formData.id" size="small" placeholder="请输入配置code"/>
        </el-form-item>

        <el-form-item label="配置值" prop="value" class="is-required" size="small">
          <el-input v-model="formData.value" size="small" placeholder="请输入配置值"/>
        </el-form-item>
