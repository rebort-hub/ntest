    ...
    <el-dialog 
      ...
      <el-form
        ...
        <el-form-item label="业务线名" prop="name" class="is-required" size="small">
          <el-input v-model="formData.name" size="small" placeholder="请输入业务线名"/>
        </el-form-item>

        <el-form-item label="业务线code" prop="code" class="is-required" size="small">
          <el-input v-model="formData.code" :disabled="!!formData.id" size="small" placeholder="请输入业务线code"/>
        </el-form-item>
